...
public interface PlayerApi {
     ...
     */
    @ApiOperation(value = "Creates a player", nickname = "createPlayer", notes = "Player or user creation", tags={ "player", })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Player Successfully Added") })
    @RequestMapping(value = "/player",
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<Void> createPlayer(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Player player) {
