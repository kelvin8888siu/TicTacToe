...
public interface MoveApi {
     ...
     */
    @ApiOperation(value = "Creates a new move in a game", nickname = "createMove", notes = "New move creation", response = Move.class, tags={ "move", })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Move Successfully Added", response = Move.class),
        @ApiResponse(code = 400, message = "Bad Request") })
    @RequestMapping(value = "/move",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<Move> createMove(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Move move) {
