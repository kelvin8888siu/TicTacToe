...
public interface GameApi {
     ...
     */
    @ApiOperation(value = "Creates a new game", nickname = "createGame", notes = "New game creation", response = Game.class, tags={ "game", })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Game Successfully Created", response = Game.class),
        @ApiResponse(code = 400, message = "Bad Request") })
    @RequestMapping(value = "/game",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<Game> createGame(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Game game) {
